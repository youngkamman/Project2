...
const createNoteCards = (array) => {
    ...
    array.forEach(obj => {
        ...
        noteCard.innerHTML = `
            ...
            <div class="card d-flex" style="width: 18rem; height: 18rem;  background-color: black; box-shadow: 0 0 1px 1px yellow;">
                <div class="card-body d-flex flex-column  justify-content-between" style="height: available;">
                    <p class="card-text" style="color: gold;">${obj.body}</p>

                    <div class="d-flex justify-content-between">
                        <button style="color: red; outline: none;background:none; border: none;" onclick="handleDelete(${obj.id})">Delete</button>
                        <button onclick="getNoteById(${obj.id})" type="button" style="color: blue; outline: none;background:none; border: none;"
